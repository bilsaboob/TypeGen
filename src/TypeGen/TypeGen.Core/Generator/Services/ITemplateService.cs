...
namespace TypeGen.Core.Generator.Services
{
    internal interface ITemplateService
    {
        ...
        string FillInterfaceTemplate(string imports, string name, string extends, string properties, string methods, string tsDoc, string customHead, string customBody, string fileHeading = null);
        string FillInterfaceDefaultExportTemplate(string imports, string name, string exportName, string extends, string properties, string methods, string tsDoc, string customHead, string customBody, string fileHeading = null);
        ...
        string FillInterfaceMethodTemplate(string modifiers, string name, string parameters, string returnType, string tsDoc);
